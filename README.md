<p align="center">
  <img src="public/favicon.svg" alt="amackerel" width="240"/>
</p>
...
Hardening headers are added onto every response: `Content-Security-Policy`,
...
`'unsafe-inline'` and no `'wasm-unsafe-eval'`. Server-rendered pages ship no inline script or style, and no
JavaScript at all.
